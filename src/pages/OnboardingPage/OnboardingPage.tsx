...
function ArrowIcon() {
  return (
    <svg
      className="onboarding__button-arrow"
      width="18"
      height="12"
      viewBox="0 0 18 12"
      fill="none"
    ...
    <div className="onboarding">
      ...
      <div className="onboarding__hero">
        <div className="onboarding__scene" aria-hidden="true">
          ...
          <span className="onboarding__dot onboarding__dot--4 onboarding__dot--green" />
          <span className="onboarding__dot onboarding__dot--8 onboarding__dot--pink" />
          <span className="onboarding__dot onboarding__dot--4 onboarding__dot--sky" />
