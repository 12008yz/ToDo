  ...
  return (
    <div className="home">
      ...
      <div className="home__scroll">
        ...
        <section className="home__section home__section--tasks" aria-labelledby="tasks-heading">
          <div className="home__tasks-heading">
            ...
            <span className="home__tasks-count">{MOCK_TODAY_TASKS_BADGE}</span>
          </div>
      ...
      <nav className="home__navbar" aria-label="Main navigation">
        ...
        <button type="button" className="home__nav-item home__nav-item--calendar" aria-label="Calendar">
          <img src="/navbar/calendar.svg" alt="" />
        </button>
        <button type="button" className="home__nav-item home__nav-item--document" aria-label="Documents">
          <img src="/navbar/todo-list.svg" alt="" />
        </button>
        <button type="button" className="home__nav-item home__nav-item--profile" aria-label="Profile">
